...
* Author URI: https://victornoyes.com
...
function add_defaults_hds() {
    ...
    if(isset($options['chkbox1']) && $options['chkbox1']) { $checked = ' checked="checked" '; }  {
		...
		$arr = array("text_string1" => "http://shop.sitedivision.com", "text_string2" => "SEARCH DOMAINS!", "text_string3" => "TRANSFER A DOMAIN AND SAVE!", "text_string4" => "SEARCH NEW DOMAINS, LIKE .ninja");
...
<b><span style="color:#0073aa;font-weight:bold">  [Domain_Search] </span></b><br/>

<b><span style="color:#0073aa;font-weight:bold">  [Vanity_Domains]</span></b><br/>

<b><span style="color:#0073aa;font-weight:bold">  [Domain_Transfer] </span></b><br/>
...
Sign up now and get access to all the following.  <a href="http://resellers.sitedivision.com/reseller.php?action=show_signupform" target="_blank">Reseller Sign Up Form</a><br/><br/>
...
</p>If you signup as a reseller you get a multi-tier separate private-labeled copy of our site. Your Resellers, their Resellers and so on can manage a beautiful retail business.<p>
...
<b>
	...
	<a href="https://wordpress.org/plugins/hyper-domains-search-reseller/" target="_blank">Plugin Page</a> | 



	<a href="https://wordpress.org/plugins/hyper-domains-search-reseller/faq/" target="_blank">Q & A</a> | 



    <a href="http://wordpress.org/support/plugin/hyper-domains-search-reseller" target="_blank" title="Hyper.Domains Form Wordpress Plugin">Support Page</a>| 



    <a href="http://sitedivision.myorderbox.com/" target="_blank">Reseller Login</a> 
